...
import 'package:supo_market/ui/page/sub_add_goods_page.dart';
...
class _ControlPageState extends State<ControlPage> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    otherUser = AUser(userName: "정태형", isUserLogin: true, imagePath: "assets/images/user.png", userSchoolNum: "20210000", userGoodsNum: 0, id: '1234', password: '12345677', isMaster: false);
